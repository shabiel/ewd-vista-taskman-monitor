%ZTLOAD1 ;SEA/RDS-TaskMan: P I: Queue ; 5/10/17 1:22pm
...
SCHED ;schedule task and quit
 ...
 TCOMMIT  ;
 ; OSE/SMH - EXTRA LINE FOR ASYNC UPDATE
 N %0 S %0=$ZF(-2,"curl http://ibis:8081/ewd-vista-pushdata/taskman?task="_ZTSK)
 ; OSE/SMH - END EXTRA LINE
EXIT ;Clean up
