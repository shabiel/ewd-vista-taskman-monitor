%ZTM4 ;SEA/RDS-TaskMan: Manager, (Waiting List) ; 5/11/17 10:58am
...
KILL ;POST^%ZTMS4, Call To Delete A Task And Unschedule It Completely
 ...
 K ^%ZTSK(ZTSK)
 ; OSE/SMH - Async Update
 N %0 S %0=$ZF(-2,"curl http://ibis:8081/ewd-vista-pushdata/taskman?task="_ZTSK_"\&action=delete")
 ; OSE/SMH - Async update end
 N ZT,ZT1,ZT2 D US
 Q
 ;
